		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapktempolyeedataempolyeedata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapktempolyeedataempolyeedata-display": {
								"semanticObject": "sapktempolyeedataempolyeedata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.kt.empolyeedata.empolyeedata",
									"url": sap.ui.require.toUrl("sap/kt/empolyeedata/empolyeedata")
								}
							}
						}
					}
